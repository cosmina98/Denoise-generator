...
separable and inspectable. The next chapter builds on this need for
inspectability by moving from generator design to model diagnosis: it develops
the evaluation framework used to compare generated and real graph distributions
more systematically, and to identify which structural or distributional
properties are preserved or lost by a generative model.
