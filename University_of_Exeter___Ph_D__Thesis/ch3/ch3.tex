...
construction, strong interpretability, and favorable behavior in low-data
...
Empirical evaluation demonstrates that NSPPK achieves a strong balance between
accuracy, robustness, and computational efficiency. Across benchmark datasets
with continuous attributes, it attains a top average rank among graph kernels
and frequently matches or surpasses GNN baselines, while remaining
training-free, deterministic, and interpretable.
...
\end{figure}
\subsection{Diagonal Dominance and Robustness: Quantitative Analysis}
\label{sec:Diagonal}
...
Under a conservative single-core evaluation setting, NSPPK delivers a favorable
...
Overall, NSPPK provides a favorable efficiency--accuracy trade-off,
...
To evaluate whether NSPPK generalizes beyond molecular graphs,
...
These results demonstrate that NSPPK generalizes well to non-molecular
...
achieves state-of-the-art performance among graph kernels and competitive
results with modern graph neural networks, despite avoiding representation
learning or end-to-end optimisation. These results demonstrate that carefully
designed explicit representations can rival learned embeddings while offering
superior interpretability and computational transparency. Because NSPPK
features correspond to explicit hashed subgraph patterns, predictive signals
can be traced back to concrete structural motifs, supporting model
...
NSPPK emphasizes explicit structural encoding, diffusion models prioritize
