...
\par\bigskip
Signed: \includegraphics[height=0.8cm]{signature.png}\\[-3pt]
\end{flushleft}
}
...
\cleardoublepage
\input{ch0/acknowledgements}

\addcontentsline{toc}{chapter}{List of Publications}
\input{ch0/publication}
...
% IMPORTANT: remove this (it was likely causing duplicated lists)
...
% \include{appendices/app_ch4}
% \include{appendices/app_ch5}
\include{appendices/app_ai_use}
