...
rows can be randomly permuted during training. Second, the clean-matrix loss can
be evaluated after matching predicted rows to target rows.
...
this staged design is that node counts, degree histograms, label histograms,
...
\begin{figure}[t]
    ...
    graph-conditioned diffusion generator from held-out
