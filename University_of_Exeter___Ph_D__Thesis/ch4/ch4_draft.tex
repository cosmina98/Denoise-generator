...
probabilities, and solves a constrained adjacency optimisation problem before
...
The final adjacency matrix is obtained by solving a binary optimisation problem.
...
for constrained adjacency optimisation. This makes the final decoding step
explicit and interpretable: the neural model proposes node and edge quantities,
while the optimisation layer enforces structural consistency.
...
integer optimisation problem, which can become expensive for large graphs.
